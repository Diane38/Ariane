...
public class Calibrate {
	...
	private final static int nbMesure=1;

	public Calibrate(Port port) throws Exception {
	...
	//sert à créer le fichier avec les valeurs du calibrage
	...
	public static void main(String[] args) throws Exception {
		Calibrate c=new Calibrate(SensorPort.S1);
	}
}
